...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('admins', function (Blueprint $table) {
            ...
            $table->string('username', 50)->nullable(false)->unique()->comment('관리자 아이디');
            $table->string('password', 255)->nullable(false)->comment('비밀번호 (암호화)');
            $table->string('role', 20)->default('admin')->nullable(false)->comment('권한 (super_admin: 최고관리자, admin: 일반관리자)');
