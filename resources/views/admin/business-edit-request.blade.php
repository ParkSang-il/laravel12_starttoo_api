...
@section('content')
    ...
    <div class="filter-section">
        ...
        <input type="text" id="usernameInput" placeholder="사용자명">
        <input type="text" id="phoneInput" placeholder="전화번호">
        <input type="text" id="businessNameInput" placeholder="상호명">
        <input type="text" id="businessNumberInput" placeholder="사업자등록번호">
        <input type="date" id="requestDateInput" placeholder="요청일시">
...
@push('scripts')
    <script>
        ...
        // 엔터키로 검색
        const searchInputs = ['usernameInput', 'phoneInput', 'businessNameInput', 'businessNumberInput', 'requestDateInput'];
        ...
        function loadList() {
            ...
            const businessNumber = document.getElementById('businessNumberInput').value.trim();
            ...
            if (businessNumber) params.append('business_number', businessNumber);
            if (requestDate) params.append('request_date', requestDate);

            let url = `/admin/api/business-edit-requests?${params.toString()}`;
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <div class="action-buttons">
                            ${item.status === 'pending' ? `
                                <button class="btn btn-approve" onclick="approveRequest(${item.id})">승인</button>
        ...
        function approveRequest(id) {
            if (!confirm('정말 승인하시겠습니까? 승인 시 원본 사업자 정보가 수정됩니다.')) {
                return;
            }

            fetch(`/admin/api/business-edit-requests/${id}/approve`, {
                method: 'POST',
                headers: {
        ...
        function confirmReject() {
            ...
            fetch(`/admin/api/business-edit-requests/${currentRejectId}/reject`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
